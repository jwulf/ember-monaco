...
module.exports = {
  ...
  included: function(parent) {
    ...
    // so we exclude it.
    parent.options.fingerprint.exclude.push("ember-monaco-magikcraft/vs");
  ...
  importTransforms() {
    return this.addons
      ...
      .reduce(
        (transforms, addon) =>
          Object.assign(transforms, addon.importTransforms()),
        {}
      );
  },
  treeForFrameScripts: function() {
    ...
    const finalScript = maybeDebug(
      new concat(mergeTrees([frameBundleTree, regeneratorTree]), {
        ...
        inputFiles: ["**/*"],
        outputFile: "ember-monaco-magikcraft/frame.js"
      }),
      "9-finalScript"
    );
